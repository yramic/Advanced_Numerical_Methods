...
class Node {
 ...
 public:
   ...
   * \param deg Degree of interpolation
   */
  Node(const std::vector<Point> PPointsTree, double x1, double x2, double y1,
   ...
   */
  std::vector<Point> getPPoints() const { return PPointsTree_; }
  /*!
 ...
 private:
  ...
  std::vector<Point>
      PPointsTree_;  //!< vector of median points of the polygone's edges
