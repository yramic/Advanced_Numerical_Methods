...
int main() {
 ...
 output2 << std::setw(15) << "#order" << std::setw(15) << "error1" << std::setw(15)
        << "error2" << std::setw(15) << "[1.01,2]" << std::setw(15) << "[1.1,2]" << std::endl;
  ...
  double int_3_exact = analytic_integral_f2(1.01,2);
  std::cout << "int_f2_exact " <<int_f2_exact << std::endl;
  std::cout << "int_3_exact " <<int_3_exact << std::endl;
  double int_4_exact = analytic_integral_f2(1.1,2);
  ...
  for (unsigned int order = 2; order < 500 ; order += 2) {
    ...
    double int_3 = parametricbem2d::ComputeIntegral(f2,1.01,2,order);
    double int_4 = parametricbem2d::ComputeIntegral(f2,1.1,2,order);
    output2 << std::setw(15) << order << std::setw(15) << fabs(int_1-int_f1_exact) << std::setw(15)
           << fabs(int_2-int_f2_exact) << std::setw(15) << fabs(int_3-int_3_exact) << std::setw(15) << fabs(int_4-int_4_exact) << std::endl;
   //std::cout << std::setw(15) << order << std::setw(15) << fabs(int_1-int_f1_exact) << std::setw(15)
          //<< fabs(int_2-int_f2_exact) << std::endl;
  }
  return 0;
}
